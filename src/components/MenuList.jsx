...
const MenuList = ({ darkTheme }) => {
  ...
  const items = [
    ...
    },
    {
      ...
      label: 'Ingressos',
      children: [
        { key: 'criarIngresso', label: 'Adicionar Ingresso' },
        { key: 'listarIngresso', label: 'Listar Ingresso' },
        { key: 'buscarIngresso', label: 'Buscar Ingresso' },
        { key: 'editarIngresso', label: 'Editar Ingresso' },
        { key: 'excluirIngresso', label: 'Excluir Ingresso' },
      ],
    },
    {
      key: 'subSalas',
